 ...
 *
 * Bags are not directly instantiated - package helper classes (BagBuilder, Serde)
...
public class Bag {
    ...
    static final String TAR_FMT = "tar";
    ...
    public enum MetadataName {
        ...
        /**
         * Returns name of metadata field
         * @return name the text representation of metadata field
         */
    ...
    // deny reader access to storage paths
    ...
    /**
     * Constructor - creates a new bag from a builder or serde
     *
     */
    Bag(Path baseDir, boolean opaque, boolean ephemeral) throws IOException {
    ...
    /**
     * Returns whether the bag is opaque.
     *
     * @return opaque true if bag is opaque (no storage paths visible)
     */
    ...
    public Path payloadFile(String relPath) throws IOException, IllegalAccessException {
        if (opaque) {
            throw new IllegalAccessException("Opaque Bag: no file access allowed");
        }
