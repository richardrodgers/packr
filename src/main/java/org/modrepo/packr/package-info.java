 ...
 * by the IETF BagIt Spec (rfc 8493) version 1.0. It represents an 'unconditionally compliant' implementation. It requires
 * Java 17 or better to run, has a single dependency on the Apache commons compression library
